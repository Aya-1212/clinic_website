        ...
        <div class="majors-grid">
            <?php while ($major = mysqli_fetch_assoc($result)): ?>
                <div class="card p-2" style="width: 18rem;">
                    <img src="<?php echo BASE_URL . "public/images/majors/" . $major['image']; ?>" class="card-img-top rounded-circle card-image-circle"
                        alt="major">
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        <h4 class="card-title fw-bold text-center"><?php echo $major['title']; ?></h4>
                        <a href="<?php echo url("doctor&id=" . $major['id']); ?>" class="btn btn-outline-primary card-button">Browse Doctors</a>
                    </div>
                </div>
            <?php endwhile; ?>
        </div>
